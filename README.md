...
- One primary folder pushes to up to five secondary folders.
...
- Supported components are add-ons, input gestures through `gestures.ini`, `nvda.ini`, speech dictionaries, configuration profiles, other root configuration files, and other root configuration folders.
- Add-ons are selected by default; potentially machine-specific configuration is opt-in.
